# Mod_server.py — Evo1_server.py ported to load Accelerate safetensors checkpoints.
# Minimal diff from Evo1_server.py:
#   1. Removed unused fvcore import.
#   2. load_model_and_normalizer() loads model.safetensors via safetensors.torch.load_file
#      instead of mp_rank_00_model_states.pt via torch.load(...)["module"].
#   3. __main__ accepts --ckpt_dir and --port via argparse instead of hardcoded strings.
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        async with websockets.serve(
            ...
            "0.0.0.0", args.port, max_size=100_000_000
        ):
