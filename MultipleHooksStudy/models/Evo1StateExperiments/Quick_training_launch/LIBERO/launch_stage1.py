"""
launch_stage1.py — Interactive Stage 1 launcher for Evo-1 LIBERO experiments.
...
_GCS_BASE = "gs://model-checkpointing/"

# ── Per-experiment config ───────────────────────────────────────────────
# save_dir   : local path on GCP instance (fast SSD under /tmp)
# gcs_bucket : GCS prefix; train.py appends basename of save_dir
...
def main():
    print("=" * 60)
    print("  Evo-1 LIBERO — Stage 1 Launcher")
