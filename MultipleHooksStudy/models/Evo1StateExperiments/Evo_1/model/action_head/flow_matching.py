...
from state_encoder import TemporalStateEncoder, build_encoder
...
class FlowmatchingActionHead(nn.Module):
    ...
    def __init__(self, config=None,
        ...
        '''
        self.state_encoder = None
        encoder_config = getattr(self.config, "encoder_config", None)
        if encoder_config is not None:
            self.state_encoder = build_encoder(encoder_config)
